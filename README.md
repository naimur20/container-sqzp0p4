...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-sqzp0p4.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-sqzp0p4.containers.anotherwebservice.com/
...
```
git clone git@github.com:naimur20/container-sqzp0p4.git
cd container-sqzp0p4
```
...
```
docker attach container-sqzp0p4
```
